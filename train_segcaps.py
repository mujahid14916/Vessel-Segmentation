...
SAVED_MODEL_PATH = 'models/segcaps-multi-channel-2-model-rop-15-0.111306-0.904506.hdf5'
INITIAL_EPOCH = 15
EPOCHS = 25
...
def main():
    ...
    log_dir = 'segcaps_logs_multi_channel_2_rop'
    tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir, histogram_freq=1)
    mcp_save = tf.keras.callbacks.ModelCheckpoint('models/segcaps-multi-channel-2-model-rop-{epoch:02d}-{loss:.6f}-{out_seg_accuracy:0.6f}.hdf5', monitor='loss', mode='min')
