...
SAVED_MODEL_PATH = 'models/segcaps-multi-channel-model-80-0.197932-0.922369.hdf5'
INITIAL_EPOCH = 0
EPOCHS = 40
...
def main():
    ...
    mcp_save = tf.keras.callbacks.ModelCheckpoint('models/segcaps-multi-channel-rop-model-{epoch:02d}-{loss:.6f}-{out_seg_accuracy:0.6f}.hdf5', monitor='loss', mode='min')
